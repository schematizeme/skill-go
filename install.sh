#!/usr/bin/env bash
# install.sh — instala a skill schematize-go no projeto atual (Claude Code).
#
...
# Como funciona: copia o corpo da skill para .claude/skills/schematize-go/ e instala os
...
# Saída: .claude/skills/schematize-go/ e .claude/commands/<slug>-*.md no alvo.
set -euo pipefail

SKILL_NAME="schematize-go"
