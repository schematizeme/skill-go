...
**Versão:** skill `schematize-go` v1.0.0. Changelog em `CHANGELOG.md`.
...
| `/go-review` | roda o gate da DoD/§37 no diff (arquivos >300, função sem doc, índice, macaquices) |
