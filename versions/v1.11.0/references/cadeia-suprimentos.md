# cadeia suprimentos — recorte Go

> **PONTEIRO, não cópia.** A normativa deste tema é da base: **`schematize-engineering`** →
> `references/cadeia-suprimentos.md`. Leia lá primeiro; aqui fica **só o que muda em Go**.
>
...
_Nada nesta área muda em Go: o piso da base vale integralmente._
