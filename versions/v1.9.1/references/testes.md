...
> **Dividida:** §22.4–§23 (padrão de script, seeds, CI, pentest §22.7–22.8, Q.A. — disciplina na skill **schematize-qa**, Makefile) estão em `references/testes-execucao.md`. Numeração contínua entre os dois.
